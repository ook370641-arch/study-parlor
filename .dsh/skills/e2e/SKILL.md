---
name: e2e
description: E2E 测试规则：mock/真实链路、禁止 skip、启动隔离静默、进程清理、稳定选择器、seed/POM 规范、source-map 维护、out/ 构建产物。改 e2e/**、tests/**/*.test.ts 前加载。
whenToUse: 编写或维护 Playwright E2E 测试、fixtures、page objects、selectors 或 e2e/source-map.json 时使用。
---
