...
const MESSAGES: Record<string, { text: string; showRetry: boolean }> = {
  ...
  TAVILY_ERROR: { text: '搜索服务暂时不可用，请稍后重试。', showRetry: true },
  ...
  JOB_TAVILY_ERROR: { text: '搜索服务暂时不可用，请稍后重试。', showRetry: true },
  ...
  JOB_LLM_ERROR: { text: 'AI 服务暂时不可用，请稍后重试。', showRetry: true },
